...
xvfb-run -a python nnmvlstm.py data=../data dump=finetunelstm_ver1 pkl=../demo/twobranch_v2.pkl lr=3e-5 bno=120  mvfinetune

xvfb-run -a python nnmvlstm.py model=finetunelstm_ver1 dump=pkldumplstm_ver1 lr=3e-5 exportpkl

xvfb-run -a python nnmvlstm.py data=../data dump=finetunelstm_ver1 pkl=./pkldumplstm_ver1/twobranch_nnmvlstm.pkl lr=3e-5 bno=120 mvfinetune

echo =================================Epoch 0===================================
xvfb-run -a python nnmvlstm.py data=$DATAFILE dump=$DUMPFILE pkl=./pkldumplstm3/twobranch_nnmvlstm2.pkl lr=$7 bno=$5 mvfinetune
